...

{
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        if (Crud::PAGE_INDEX === $pageName) {
            ...
            if ($this->adminContextProvider->getContext()->getRequest()->query->get('menuIndex') == 7) {
                ...
                return [$id, $lettre, $numero, $centre, $titreProjet, $description, $selectionnee, $nomLycee, $denominationLycee, $lyceeLocalite, $lyceePays, $lyceeAcademie, $IdProf1, $IdProf2, $contribfinance, $origineprojet, $partenaire, $createdAt, $uploadedAt, $uai, $idAdage];
            }
    ...
    */
    ...
    public function updateEntity(EntityManagerInterface $entityManager, $entityInstance): void
    {
        ...
        $entityInstance->setUploadedAt(new \DateTime());
